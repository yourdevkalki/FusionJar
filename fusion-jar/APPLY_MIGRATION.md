...
Visit your Supabase dashboard SQL Editor:
**https://trlzbqhoxpxwqghunoxg.supabase.co/project/trlzbqhoxpxwqghunoxg/sql**
...
```sql
-- =====================================================
-- COMPLETE MIGRATION FOR INVEST.TX UI
-- =====================================================
...
CREATE TRIGGER IF NOT EXISTS update_investment_templates_updated_at 
...
After running the SQL, verify the migration was successful by running this test: