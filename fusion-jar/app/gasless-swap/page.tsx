    ...
    <div className="min-h-screen bg-background py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-background rounded-lg shadow-lg p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-medium text-white mb-2">Get Quote</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-medium text-white mb-2">Sign Intent</h3>
                <p className="text-sm text-gray-500">
              ...
              <div className="text-center">
                ...
                <h3 className="font-medium text-white mb-2">Execute</h3>
                <p className="text-sm text-gray-500">
          ...
          <div className="mt-6 bg-purple rounded-lg p-6">
